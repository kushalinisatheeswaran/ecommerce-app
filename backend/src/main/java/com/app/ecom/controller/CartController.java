...
public class CartController {
    ...
    public ResponseEntity<String> updateCartItem(
        ...
        String resolvedUserId = identityResolver.resolveUserId(userId);
        boolean updated = cartService.updateCartItemQuantity(resolvedUserId, productId, quantity);

        if (!updated) {
            return ResponseEntity.badRequest().body("Failed to update cart item quantity. Verify stock level.");
        }
